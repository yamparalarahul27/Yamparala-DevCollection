...
export const componentRegistry: readonly ComponentRegistryEntry[] = [
  ...
  },
  {
    href: "/glossy-button",
    title: "Glossy Button",
    description: "Shared CTA primitive with tone/size/shape. Experience skins and consolidated specialty buttons wrap this.",
    color: "#323232",
    category: "Buttons",
    status: "Latest",
    sourceFiles: [
  ...
  },
  {
    ...
    description: "Stacked Apply Fix / Preview Fix wrappers around GlossyButton mint and dark tones.",
    color: "#08c78d",
    category: "Buttons",
    status: "Latest",
    sourceFiles: [
  ...
  },
  {
    ...
    description: "Thin wrapper around GlossyButton tone=ink shape=pill.",
    color: "#0a0d1a",
    category: "Buttons",
    status: "Latest",
    sourceFiles: [
  ...
  },
  {
    ...
    description: "Paired Preview / Deploy wrappers around GlossyButton light and steel tones.",
    color: "#2d2d34",
    category: "Buttons",
    status: "Latest",
    sourceFiles: [
  ...
  },
  {
    href: "/earn-button",
    title: "Earn Button",
    description: "Thin wrapper around GlossyButton tone=green shape=pill with a slight tilt.",
    color: "#006b36",
    category: "Buttons",
    status: "Latest",
    sourceFiles: [
